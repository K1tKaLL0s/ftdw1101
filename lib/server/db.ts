...
type RpcName =
  ...
  | "app_account_profile"
  | "app_update_display_name"
  | "app_increment_avatar_version"
  | "app_active_avatar_version"
  | "app_user_week"
  | "app_request_password_reset"
  | "app_admin_list_password_reset_requests"
  | "app_admin_prepare_request_password_reset"
  | "app_admin_dismiss_password_reset_request"
  | "app_prepare_self_password_change"
  | "app_prepare_recovery_password_change"
  | "app_finish_self_password_change";
